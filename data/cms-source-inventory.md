...
Full raw CMS files are stored locally under `local/raw/` and are not committed to GitHub. Only verified source headers and 1,000-row samples are committed.
...
| 3 | Medicare Inpatient Hospitals by Provider and Service | inpatient_provider_service_2024.csv | 2024 | Stretch | bronze_cms_inpatient_payment_raw | 145,879 | 36.22 | DRG field handled in Silver if included |
